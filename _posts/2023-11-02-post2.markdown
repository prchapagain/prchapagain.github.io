...
title: creating post using bash script
author: khumnath
category: others
tags: [ bash, blog ]
img: ":bash.png"
...
---
this post is generated using a bash script. i generated post and language pair post for nepali language using below script. 
...
time_offset=`date "+%z"`
read -p "Enter the post filename: " post_variable;
