---
lng_pair: id_02-11-2023
title: ब्यास स्क्रिप्ट प्रयोग गरेर पोष्ट सिर्जना गर्दै
author: खुमनाथ
category: others
tags: [ ब्यास, ब्लग ]
img: ":post_bash.png"
date: 2023-11-02 21:04:37 +0900
#remove '#' on published: false to unpublish post
#published: false
#markdown formated page contents below
---
![](../assets/img/posts/post_bash.png)


यो पोस्ट एक ब्याश स्क्रिप्ट प्रयोग गरेर सिर्जना गरिएको छ। मैले तलको कोड प्रयोग गरेर अंग्रेजी पोस्ट र नेपाली पोस्ट सिर्जना गरें। 
  ```bash
  #!/bin/bash
